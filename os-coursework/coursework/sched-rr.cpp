...
public:
	...
	void add_to_runqueue(SchedulingEntity& entity) override
	{
		...
		// adds entity to the back of list
	...
	SchedulingEntity *pick_next_entity() override
	{
		...
		//return first element in list if there is only 1 element
		if (runqueue.count() == 1) return runqueue.first();

		// disables interrupts
		UniqueIRQLock l;

		//remove from front of list and add to end of list
		auto entity = runqueue.pop();
		runqueue.append(entity);
		return entity;
	}
